...
PROJECT_DIR="/home/haligh/projects/kennerliga/api"
VENV_PYTHON="/home/haligh/projects/kennerliga/api/.venv/bin/python"

# 1) Run the backup command
export DJANGO_SETTINGS_MODULE="django_rest.settings_production"
"$VENV_PYTHON" "$PROJECT_DIR/manage.py" db_backup
...
if [ "$TOMORROW_DAY" = "01" ]; then
    ...
    "$VENV_PYTHON" "$PROJECT_DIR/manage.py" start_new_season
fi
