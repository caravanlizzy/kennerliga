    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform',
                 models.CharField(choices=[('BGA', 'BGA'), ('Yucata', 'Yucata')], default='BGA', max_length=6)),
            ],
        ),
        migrations.CreateModel(
            name='GameOption',
            fields=[
                ...
                ('game', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                           related_name='options', to='game.game')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choices',
                                             to='game.gameoption')),
            ],
        ),
    ]
