...
from season.views import (
    SeasonViewSet,
    SeasonRegistrationView,
    SeasonScoreboardViewSet,
    CurrentSeasonView,
...
router.register(
    "season-scoreboards", SeasonScoreboardViewSet, basename="season-scoreboards"
)
router.register(
    "season-participants", SeasonParticipantViewSet, basename="season-participants"
)
