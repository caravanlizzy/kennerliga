<template>
  ...
  <div v-else-if="standings" class="rounded-borders q-pa-md">
    ...
    >
      <thead>
        <tr>
          <th
            class="text-left text-uppercase text-weight-medium q-py-xs q-px-sm"
          >
            Player
          </th>

          <th
            class="text-center text-uppercase text-weight-medium q-py-xs q-px-sm"
          >
            Highest L
          </th>
  ...
  <!-- No data -->
  <div v-else class="text-caption text-grey-7">No standings available.</div>
</template>
