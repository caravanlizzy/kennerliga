...
onMounted(async () => {
  try {
    ...
    // Fill basic fields + map option/choice/condition tree via composable
    loadFromDto(gameData);
...
const onSubmit = async () => {
  try {
    // In edit mode `platform` holds the numeric platform id.
    const platformId = platform.value as number | null;
